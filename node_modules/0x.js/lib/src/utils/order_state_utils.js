    ...
    OrderStateUtils.prototype.getOrderRelevantStateAsync = function (signedOrder) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        exchange = this._orderFilledCancelledFetcher._exchangeWrapper;
                        zrxTokenAddress = exchange.getZRXTokenAddress();
                        orderHash = _0x_1.ZeroEx.getOrderHashHex(signedOrder);
                        return [4 /*yield*/, this._balanceAndProxyAllowanceFetcher.getBalanceAsync(signedOrder.makerTokenAddress, signedOrder.maker)];
                    case 1:
                        makerBalance = _a.sent();
                        return [4 /*yield*/, this._balanceAndProxyAllowanceFetcher.getProxyAllowanceAsync(signedOrder.makerTokenAddress, signedOrder.maker)];
                    case 2:
                        makerProxyAllowance = _a.sent();
                        return [4 /*yield*/, this._balanceAndProxyAllowanceFetcher.getBalanceAsync(zrxTokenAddress, signedOrder.maker)];
                    case 3:
                        makerFeeBalance = _a.sent();
                        return [4 /*yield*/, this._balanceAndProxyAllowanceFetcher.getProxyAllowanceAsync(zrxTokenAddress, signedOrder.maker)];
                    case 4:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this._orderFilledCancelledFetcher.getCancelledTakerAmountAsync(orderHash)];
                    case 6:
