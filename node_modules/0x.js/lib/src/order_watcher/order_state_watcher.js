...
var OrderStateWatcher = /** @class */ (function () {
    function OrderStateWatcher(web3Wrapper, token, exchange, config) {
        ...
        var stateLayer = _.isUndefined(config) || _.isUndefined(config.stateLayer) ? types_1.BlockParamLiteral.Latest : config.stateLayer;
        this._eventWatcher = new event_watcher_1.EventWatcher(web3Wrapper, pollingIntervalIfExistsMs, stateLayer);
        this._balanceAndProxyAllowanceLazyStore = new balance_proxy_allowance_lazy_store_1.BalanceAndProxyAllowanceLazyStore(token, stateLayer);
        this._orderFilledCancelledLazyStore = new order_filled_cancelled_lazy_store_1.OrderFilledCancelledLazyStore(exchange, stateLayer);
    ...
    OrderStateWatcher.prototype.removeOrder = function (orderHash) {
        ...
        var exchange = this._orderFilledCancelledLazyStore._exchangeWrapper;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        log = logIfExists;
                        maybeDecodedLog = this._web3Wrapper.abiDecoder.tryToDecodeLogOrNoop(log);
