...
var ZeroEx = /** @class */ (function () {
    ...
    ZeroEx.prototype.signOrderHashAsync = function (orderHash, signerAddress, shouldAddPersonalMessagePrefix) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, order_utils_1.signOrderHashAsync(this._web3Wrapper.getProvider(), orderHash, signerAddress, shouldAddPersonalMessagePrefix)];
            });
        });
    };
    /**
    ...
    ZeroEx.prototype.awaitTransactionMinedAsync = function (txHash, pollingIntervalMs, timeoutMs) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var transactionReceiptWithDecodedLogs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._web3Wrapper.awaitTransactionMinedAsync(txHash, pollingIntervalMs, timeoutMs)];
                    case 1:
     ...
     */
    ZeroEx.prototype.createOrderStateWatcher = function (config) {
        return new order_state_watcher_1.OrderStateWatcher(this._web3Wrapper, this.token, this.exchange, config);
    };
    /*
