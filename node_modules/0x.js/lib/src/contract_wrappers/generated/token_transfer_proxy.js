...
var TokenTransferProxyContract = /** @class */ (function (_super) {
    ...
    function TokenTransferProxyContract(abi, address, provider, defaults) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('transferFrom(address,address,address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [token, from, to, value], base_contract_1.BaseContract._bigNumberToString.bind(this)), token = _a[0], from = _a[1], to = _a[2], value = _a[3];
                                encodedData = self
                                    ._lookupEthersInterface('transferFrom(address,address,address,uint256)')
                                    .functions.transferFrom(token, from, to, value).data;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('addAuthorizedAddress(address)').inputs;
                                target = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [target], base_contract_1.BaseContract._bigNumberToString.bind(this))[0];
                                encodedData = self
                                    ._lookupEthersInterface('addAuthorizedAddress(address)')
                                    .functions.addAuthorizedAddress(target).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
