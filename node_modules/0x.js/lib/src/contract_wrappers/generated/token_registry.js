...
var TokenRegistryContract = /** @class */ (function (_super) {
    ...
    function TokenRegistryContract(abi, address, provider, defaults) {
        var _this = _super.call(this, abi, address, provider, defaults) || this;
        _this.removeToken = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('removeToken(address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_token, _index], base_contract_1.BaseContract._bigNumberToString.bind(this)), _token = _a[0], _index = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('removeToken(address,uint256)')
                                    .functions.removeToken(_token, _index).data;
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('setTokenSwarmHash(address,bytes)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_token, _swarmHash], base_contract_1.BaseContract._bigNumberToString.bind(this)), _token = _a[0], _swarmHash = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('setTokenSwarmHash(address,bytes)')
                                    .functions.setTokenSwarmHash(_token, _swarmHash).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('addToken(address,string,string,uint8,bytes,bytes)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_token, _name, _symbol, _decimals, _ipfsHash, _swarmHash], base_contract_1.BaseContract._bigNumberToString.bind(this)), _token = _a[0], _name = _a[1], _symbol = _a[2], _decimals = _a[3], _ipfsHash = _a[4], _swarmHash = _a[5];
                                encodedData = self
                                    ._lookupEthersInterface('addToken(address,string,string,uint8,bytes,bytes)')
                                    .functions.addToken(_token, _name, _symbol, _decimals, _ipfsHash, _swarmHash).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('setTokenName(address,string)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_token, _name], base_contract_1.BaseContract._bigNumberToString.bind(this)), _token = _a[0], _name = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('setTokenName(address,string)')
                                    .functions.setTokenName(_token, _name).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('setTokenIpfsHash(address,bytes)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_token, _ipfsHash], base_contract_1.BaseContract._bigNumberToString.bind(this)), _token = _a[0], _ipfsHash = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('setTokenIpfsHash(address,bytes)')
                                    .functions.setTokenIpfsHash(_token, _ipfsHash).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('setTokenSymbol(address,string)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_token, _symbol], base_contract_1.BaseContract._bigNumberToString.bind(this)), _token = _a[0], _symbol = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('setTokenSymbol(address,string)')
                                    .functions.setTokenSymbol(_token, _symbol).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('transferOwnership(address)').inputs;
                                newOwner = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [newOwner], base_contract_1.BaseContract._bigNumberToString.bind(this))[0];
                                encodedData = self
                                    ._lookupEthersInterface('transferOwnership(address)')
                                    .functions.transferOwnership(newOwner).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
