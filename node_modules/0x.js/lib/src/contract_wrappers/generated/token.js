...
var TokenContract = /** @class */ (function (_super) {
    ...
    function TokenContract(abi, address, provider, defaults) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('approve(address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_spender, _value], base_contract_1.BaseContract._bigNumberToString.bind(this)), _spender = _a[0], _value = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('approve(address,uint256)')
                                    .functions.approve(_spender, _value).data;
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('transferFrom(address,address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from, _to, _value], base_contract_1.BaseContract._bigNumberToString.bind(this)), _from = _a[0], _to = _a[1], _value = _a[2];
                                encodedData = self
                                    ._lookupEthersInterface('transferFrom(address,address,uint256)')
                                    .functions.transferFrom(_from, _to, _value).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('transfer(address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_to, _value], base_contract_1.BaseContract._bigNumberToString.bind(this)), _to = _a[0], _value = _a[1];
                                encodedData = self._lookupEthersInterface('transfer(address,uint256)').functions.transfer(_to, _value)
                                    .data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
                            case 1:
