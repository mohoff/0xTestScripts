...
var DummyTokenContract = /** @class */ (function (_super) {
    ...
    function DummyTokenContract(abi, address, provider, defaults) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }), self.setBalance.estimateGasAsync.bind(self, _target, _value))];
                            case 1:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('setBalance(address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_target, _value], base_contract_1.BaseContract._bigNumberToString.bind(this)), _target = _a[0], _value = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('setBalance(address,uint256)')
                                    .functions.setBalance(_target, _value).data;
