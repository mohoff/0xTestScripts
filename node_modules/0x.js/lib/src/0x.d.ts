import { ContractWrappersConfig, EtherTokenWrapper, ExchangeWrapper, TokenRegistryWrapper, TokenTransferProxyWrapper, TokenWrapper } from '@0xproject/contract-wrappers';
...
export declare class ZeroEx {
     ...
     */
    createOrderWatcherAsync(config?: OrderWatcherConfig): Promise<OrderWatcher>;
}
