...
export declare class LedgerSubprovider extends BaseWalletSubprovider {
    private _nonceLock;
    private _connectionLock;
    private _networkId;
    private _baseDerivationPath;
    private _ledgerEthereumClientFactoryAsync;
    private _ledgerClientIfExists?;
    private _shouldAlwaysAskForConfirmation;
    private _addressSearchLimit;
    /**
    ...
    private _findDerivedKeyInfoForAddress(initalHDKey, address);
}
