...
var LedgerSubprovider = /** @class */ (function (_super) {
    ...
    LedgerSubprovider.prototype.signTransactionAsync = function (txParams) {
        return __awaiter(this, void 0, void 0, function () {
            var initialDerivedKeyInfo, derivedKeyInfo, _a, tx, txHex, fullDerivationPath, result, signedChainId, err, signedTxHex, err_1;
    ...
    LedgerSubprovider.prototype.signPersonalMessageAsync = function (data, address) {
        return __awaiter(this, void 0, void 0, function () {
            var initialDerivedKeyInfo, derivedKeyInfo, _a, fullDerivationPath, result, v, vHex, signature, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
