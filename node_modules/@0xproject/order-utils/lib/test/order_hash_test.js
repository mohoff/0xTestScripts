...
describe('Order hashing', function () {
    describe('#getOrderHashHex', function () {
        ...
        var order = {
            maker: src_1.constants.NULL_ADDRESS,
            taker: src_1.constants.NULL_ADDRESS,
            feeRecipient: src_1.constants.NULL_ADDRESS,
            makerTokenAddress: src_1.constants.NULL_ADDRESS,
            takerTokenAddress: src_1.constants.NULL_ADDRESS,
        ...
        it('calculates the order hash', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                orderHash = src_1.getOrderHashHex(order);
        ...
        it('throws a readable error message if taker format is invalid', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                expect(function () { return src_1.getOrderHashHex(orderWithInvalidtakerFormat); }).to.throw(expectedErrorMessage);
                return [2 /*return*/];
            });
        }); });
    });
