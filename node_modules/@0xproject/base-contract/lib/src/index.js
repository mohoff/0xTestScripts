...
var BaseContract = /** @class */ (function () {
    function BaseContract(contractName, abi, address, provider, txDefaults) {
        ...
        var methodAbis = this.abi.filter(function (abiDefinition) { return abiDefinition.type === types_1.AbiType.Function; });
    ...
    BaseContract._lookupConstructorAbi = function (abi) {
        var constructorAbiIfExists = _.find(abi, function (abiDefinition) { return abiDefinition.type === types_1.AbiType.Constructor; });
    ...
    BaseContract.prototype._lookupAbi = function (functionSignature) {
        var methodAbi = _.find(this.abi, function (abiDefinition) {
            if (abiDefinition.type !== types_1.AbiType.Function) {
                return false;
            }
